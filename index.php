  ...
  <table class="table  table-bordered">
    <tr>
    	...
    	<tr>
	    	...
	    	<td>
                <a href="detailiklan.php?id_iklan=<?php echo $iklan['id_iklan'] ?>" class="btn btn-info btn-sm" >Detail</a>
	    		<a href="editiklan.php?id_iklan=<?php echo $iklan['id_iklan'] ?>" class="btn btn-success btn-sm">Edit</a>
	...
	<a href="tambahiklan.php" class="btn btn-primary btn-sm">Tambah iklan</a>
